...
class ColumnLogicalOperation<
    ...
    TComparisons extends (ColumnComparisonOperation<TDbType, any, any, any, any> | ColumnLogicalOperation<TDbType, any>)[],
> {
...
function and<
    TComparisons extends (ColumnComparisonOperation<TDbType, any, any, any, any> | ColumnLogicalOperation<TDbType, any>)[],
    TDbType extends DbType = TComparisons extends (ColumnComparisonOperation<infer TDbType1 extends DbType, any, any, any, any> | ColumnLogicalOperation<infer TDbType2, any>)[] ? TDbType1 & TDbType2 : never
>(...ops: TComparisons) {
