...
function functionEq<
    ...
    TReturnType extends TDbType extends PgDbType ? PgValueTypes : never,
    TAppliedQColumn extends QueryColumn<TDbType, Column<TDbType, JsTypeToPgTypes<TReturnType>, any, any>, any, any>,
>(this: ColumnSQLFunction<TDbType, TArgs, TReturnType>, value: TAppliedQColumn): ColumnComparisonOperation<
    TDbType,
    ColumnSQLFunction<TDbType, TArgs, TReturnType>,
    undefined,
    [TAppliedQColumn],
...
function functionEq<
    ...
    TReturnType extends TDbType extends PgDbType ? PgValueTypes : never,
    TAppliedSQLFunction extends ColumnSQLFunction<TDbType, any, TReturnType>,
>(this: ColumnSQLFunction<TDbType, TArgs, TReturnType>, value: TAppliedSQLFunction): ColumnComparisonOperation<
    TDbType,
    ColumnSQLFunction<TDbType, TArgs, TReturnType>,
    undefined,
    undefined,
...
>(this: ColumnSQLFunction<TDbType, TArgs, TReturnType>, value: TParamMedian
...
function functionEq<
    ...
    TParamMedian extends QueryParamMedian<any>,
    TParamName extends TParamMedian extends QueryParamMedian<infer U> ? U : never,
    TAppliedQColumn extends QueryColumn<TDbType, Column<TDbType, JsTypeToPgTypes<TReturnType>, any, any>, any, any> | undefined,
    TAppliedSQLFunction extends ColumnSQLFunction<TDbType, any, TReturnType> | undefined
>
    (this: ColumnSQLFunction<TDbType, TArgs, TReturnType>, value: TValueType | TParamMedian | TAppliedQColumn | TAppliedSQLFunction) {
