...
type TableToColumnsMap<TDbType extends DbType, T extends { [key: string]: QueryTable<TDbType, any, any, any, any, any> | IExecuteableQuery<TDbType, any, any, any, any, any, any, any> }> = {
    [K in keyof T]: ColumnsSelection<
        TDbType,
        T[K],
        T[K] extends QueryTable<TDbType, any, any, any, any, any> ? T[K]["columnsList"] :
        T[K] extends IExecuteableQuery<TDbType, any, any, infer TResult, any, any, any, any> ?
...
type TablesToObject<
    ...
    TFrom extends readonly (QueryTable<TDbType, any, any, any, any, any> | IExecuteableQuery<TDbType, any, any, any, any, any, any, any>)[],
...
> = {
    ...
    (
        ...
        TInnerJoinSpecs extends JoinSpecsType<TDbType> ?
        {
            ...
            T["table"] extends IExecuteableQuery<TDbType, any, any, any, any, any, any, infer TAs> ?
            TAs extends undefined ? never : TAs & string :
            never
            ]: T["table"]
        }
