...
type ColumnsToResultMap<TDbType extends DbType, T extends TResultShape<TDbType>[] | TResultShape<TDbType> | undefined> =
    DeepPrettify<
        ...
        {
            [K in keyof TResult as TResult[K] extends IComparable<TDbType, any, any, any, any> ? K : never]:
            TResult[K] extends IComparable<TDbType, any, any, infer TFinalType, any> ? TFinalType :
            never
        }[] :
...
type AccumulateOrderByParams<
    TDbType extends DbType,
    TParams extends readonly QueryParam<any, any, any>[] | undefined,
...
> =
    ...
    TParams extends QueryParam<any, any, any>[] ? [...TParams, ...InferParamsFromOrderByParams<TDbType, TOrderByParams>] :
    never;
...
type InferParamsFromOrderByParams<TDbType extends DbType, TOrderByParams extends OrderBySpecs<TDbType>> =
    ...
    First extends IComparable<TDbType, infer TParams, any, any, false> ? Rest extends OrderBySpecs<TDbType> ?
    [...(TParams extends undefined ? [] : TParams), InferParamsFromOrderByParams<TDbType, Rest>] :
    [...(TParams extends undefined ? [] : TParams)] :
    First extends [IComparable<TDbType, infer TParams, any, any, false>, OrderType] ? Rest extends OrderBySpecs<TDbType> ?
    [...(TParams extends undefined ? [] : TParams), InferParamsFromOrderByParams<TDbType, Rest>] :
    [...(TParams extends undefined ? [] : TParams)] :
    [] :
    [];
