...
> =
    ...
    First extends IComparable<TDbType, any, any, infer TValType, any, any, any> ? TValType :
...
> = TArgs extends readonly [infer First, ...infer Rest] ?
    ...
    First extends IComparable<TDbType, any, any, any, infer TFinalType, any, any> ?
...
type InferReturnTypeFromJSONBuildObjectParam<TDbType extends DbType, TObj extends JSONBuildObjectParam<TDbType>> =
    DeepPrettify<{
        ...
        TObj[K] extends IComparable<TDbType, any, any, any, infer TFinalType, any, any> ? TFinalType :
...
type InferIsAggFromJSONFn<TDbType extends DbType, TObj extends JSONBuildObjectParam<TDbType>> =
    ...
    FirstKey extends IComparable<TDbType, any, any, any, any, true, any> ? true :
